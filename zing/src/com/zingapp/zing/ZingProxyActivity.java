...
public class ZingProxyActivity extends Activity
{
	protected void onCreate (Bundle savedInstanceState)
	{
		...
		String classNames[] = { "com.zingapp.zing.ZingActivity", "com.zingapp.zing.ZingNativeActivity" };
